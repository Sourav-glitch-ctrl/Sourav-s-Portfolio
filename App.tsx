...
function App() {
  return (
    <div className="font-sans min-h-screen relative text-slate-200 selection:bg-sky-500 selection:text-white print:bg-white print:text-black">
      {/* Global Abstract Background */}
      <div className="fixed inset-0 z-[-1] bg-slate-950 overflow-hidden print:hidden">
        {/* Abstract Gradients */}
